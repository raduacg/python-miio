...
class DeviceControlApp(QMainWindow):
    def __init__(self):
        ...
        # Brightness steps for fade to black
        self.brightness_steps = [0, 25, 50, 75, 100]
        self.fade_transition_duration = 4.8  # 4.8 seconds for full fade transition
        self.fade_step_duration = self.fade_transition_duration / (len(self.brightness_steps) - 1)
    ...
    def ambient_loop(self):
        sample_interval = 0.048  # 48 milliseconds
            ...
            try:
                if self.paused:
                    ...
                    if self.target_brightness != 0:
                        self.initiate_fade_transition(0)
    ...
    def focus_monitor_loop(self):
        ...
        focus_delay = 2.0     # Delay before acting on focus change
        ...
        while True:
            try:
                ...
                is_paused = any(keyword in active_window_title for keyword in self.focus_keywords)
