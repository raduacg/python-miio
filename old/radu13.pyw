...
class DeviceControlApp(QMainWindow):
    ...
    def ambient_loop(self):
        ...
        while not self.stop_ambient.is_set():
            ...
            try:
                ...
                img_small = cv2.resize(warped, (80, 80))  # Reduced size for faster processing
                ...
                # Debug: Print bright ratio (optional)
                # print(f"Bright ratio: {bright_ratio*100:.2f}%")
    ...
    def command_sender_loop(self):
        ...
        while True:
            try:
                ...
                if (hasattr(self, 'fade_transition_start_time') and self.fade_transition_start_time is not None) \
                        or color_diff > 3 or brightness_diff > 3:
    ...
    def focus_monitor_loop(self):
        ...
        focus_delay = 2.0     # Reduced delay for quicker response
