...
class DeviceControlApp(QMainWindow):
    ...
    def select_region_with_mouse_clicks(self):
        ...
        print("Please click four points to define the rectangle")
        ...
        if len(self.mouse_click_positions) >= 4:
            ...
            x_coords = [pos[0] for pos in self.mouse_click_positions[:2]]
            y_coords = [pos[1] for pos in self.mouse_click_positions[:2]]
            x1, x2 = x_coords
            y1, y2 = y_coords
